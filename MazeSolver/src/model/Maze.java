...
public class Maze {
    ...
    /** Clears all inner cells to PATH (keeps border walls). Alias for resetAll. */
    public void clearAll() {
        buildDefault();
    }

    /** Resizes the maze to new dimensions and resets. */
    ...
    /** Clears the current START cell back to PATH. */
    public void clearStart() {
        grid[startRow][startCol] = Cell.PATH;
    }

    /** Clears the current END cell back to PATH. */
    public void clearEnd() {
        grid[endRow][endCol] = Cell.PATH;
    }
