...
public class SettingsPanel extends JPanel {
    ...
    private JPanel buildAppearanceCard() {
        ...
        String btnText = Theme.isDarkMode() ? "Switch to Light Mode" : "Switch to Dark Mode";
        ...
        themeToggleBtn.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                Theme.toggleMode();
                themeToggleBtn.setText(Theme.isDarkMode() ? "Switch to Light Mode" : "Switch to Dark Mode");
